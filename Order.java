...
public class Order implements Printable {
	...
	// your code here
        ...
        return subtotal.setScale(2, RoundingMode.HALF_UP); // Use RoundingMode 
    }
	...
	// your code here
        ...
        for (Map.Entry<MenuItem, Integer> entry : this.items.entrySet()) {
            ...
            builder.append(String.format(lineFormat, item.getListing(), quantity, item.getPrice(), total));
        }
        builder.append(String.format(totalFormat, "Subtotal", getSubTotal()));
        builder.append(String.format(totalFormat, "Taxes", getTaxes()));
        builder.append(String.format(totalFormat, "Total", getTotal()));
